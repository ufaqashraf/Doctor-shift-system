...
var FormControls = function () {
    ...
    var createLineItem = function () {
        ...
        $('#unit-calls-table tbody').append(line_item);
        $('#line_item-edu_year-'+global_counter).datepicker({ format: 'yyyy-mm-dd' });
        $('#line_item-joining_date-'+global_counter).datepicker({ format: 'yyyy-mm-dd' });
        $('#line_item-leaving_date-'+global_counter).datepicker({ format: 'yyyy-mm-dd' });
