...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="{{ route('admin.employees.salary',[$Employee1->id]) }}">Salary</a></li>
            <li><a href="{{ route('admin.employees.experience',[$Employee1->id]) }}">Work Experience</a></li>
            ...
            <li><a href="{{ route('admin.employees.documents',[$Employee->id]) }}">Documents</a></li>
        </ul>
    </div>
</nav>
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Update Employee's salary detail</h3>
        <a href="{{ route('admin.employees.index') }}" class="btn btn-success pull-right">Back</a>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::model($Employee1, ['method' => 'post', 'id' => 'validation-form', 'route' => ['admin.employees.salarydata', $Employee1->id]]) !!}
    <div class="box-body">
...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="{{ route('admin.employees.salary',[$Employee->id]) }}">Salary</a></li>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Insert Employee's salary detail</h3>
        <a href="{{ route('admin.employees.index') }}" class="btn btn-success pull-right">Back</a>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::model($Employee, ['method' => 'post', 'id' => 'validation-form', 'route' => ['admin.employees.salarydata', $Employee->id]]) !!}
    <div class="box-body">
        @include('admin.employees.salary_fields')
    </div>
    <!-- /.box-body -->
