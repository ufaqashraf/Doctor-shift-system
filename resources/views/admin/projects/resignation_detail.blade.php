...
@section('content')
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="{{ route('admin.employees.resignation',[$Employee1->id]) }}">Resignation</a></li>
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Update Employee's Resignation detail</h3>
            <a href="{{ route('admin.employees.index') }}" class="btn btn-success pull-right">Back</a>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::model($Employee1, ['method' => 'post', 'id' => 'validation-form', 'route' => ['admin.employees.resignationdata', $Employee1->id]]) !!}
        <div class="box-body">
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="{{ route('admin.employees.resignation',[$Employee->id]) }}">Resignation</a></li>
            </ul>
        </div>
    </nav>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Insert Employee's Resignation detail</h3>
            <a href="{{ route('admin.employees.index') }}" class="btn btn-success pull-right">Back</a>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        {!! Form::model($Employee, ['method' => 'post', 'id' => 'validation-form', 'route' => ['admin.employees.resignationdata', $Employee->id]]) !!}
        <div class="box-body">
            @include('admin.employees.resignation_fields')
        </div>
        <!-- /.box-body -->
