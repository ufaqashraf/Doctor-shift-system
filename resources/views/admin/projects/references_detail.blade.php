...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="{{ route('admin.employees.references',[$Employee->id]) }}">References</a></li>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Insert Employee's References</h3>
        <a href="{{ route('admin.employees.index') }}" class="btn btn-success pull-right">Back</a>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    {!! Form::model($Employee, ['method' => 'post', 'id' => 'validation-form', 'route' => ['admin.employees.referencesdata', $Employee->id]]) !!}
    <div class="box-body">
        @include('admin.employees.references_fields')
    </div>
    <!-- /.box-body -->
    ...
    @include('admin.employees.references_items_template')
    {!! Form::close() !!}
</div>
@stop
...
@section('javascript')
    ...
    <script src="{{ url('public/js') }}/admin/employees/education_history.js" type="text/javascript"></script>
@endsection