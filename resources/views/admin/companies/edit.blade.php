...
<section class="content">
    <div class="col-md-12">
        ...
        <div class="card card-info">
            ...
            <h3 class="card-title">Update Companies</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            {!! Form::model($Companie, ['method' => 'PUT', 'id' => 'validation-form', 'enctype'=>'multipart/form-data','route' => ['admin.companies.update', $Companie->id], 'data-parsley-validate']) !!}
                <div class="card-body">
