...
<section class="content">
    <div class="col-md-12">
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            {!! Form::open(['method' => 'POST', 'route' => ['admin.regions.store'], 'data-parsley-validate']) !!}
                <div class="card-body">
                    <div class="row">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{route('admin.regions.index')}}" class="btn btn-outline-secondary float-right">{{trans('global.app_back')}}</a>
                </div>
                <!-- /.card-footer -->
            {!! Form::close() !!}
        </div>
